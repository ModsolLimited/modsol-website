...
const tabContent: Record<Tab, {
  ...
  "THE MODBLOCK": {
    ...
    logoWidth: 160,
    heading: "THE BAR. THE KITCHEN. THE SUITE.",
    body: "The Modblock is the structural backbone behind pop-up restaurants, festival bars, brand hospitality suites and temporary dining environments — delivering hotel-standard spaces in hours, not days. Insulated, weatherproof and fully serviced, it performs wherever the brief takes it.",
    bullets: [
      "Fully insulated for year-round operation",
      "Serviced units — plumbing and electrical ready",
      "From single kiosk to full restaurant footprint",
    ],
  ...
  "THE MODWALL": {
    ...
    logoWidth: 160,
    heading: "INTERIORS THAT EARN THEIR KEEP.",
    body: "The Modwall delivers the premium interior fit-out that hospitality environments require — acoustic separation between dining areas, clean service corridors, integrated back-bar and kitchen dividers. Every surface finish is available, from raw timber effect to brushed metal and full vinyl wrap.",
    bullets: [
      "Acoustic panel options for dining environments",
      "Integrated service hatch and pass-through options",
      "Any surface finish — timber, metal, branded vinyl",
    ],
  ...
  "THE MODFRAME": {
    ...
    body: "The Modframe provides the covered outdoor dining, terrace and bar environments that extend hospitality spaces beyond four walls. Whether a festival food court canopy, a branded outdoor terrace or a roadside pop-up fascia, it extends the guest experience without permanent infrastructure.",
    bullets: [
      "Weatherproof canopy and terrace configurations",
      "Integrated lighting and branding options",
      "Rapid deployment — operational in hours",
    ],
...
const stats = [
  { value: "1 DAY",  label: "FROM INSTALL" },
  { value: "4.8M",   label: "WALL HEIGHT" },
  { value: "100%",   label: "WEATHERPROOF" },
  { value: "∞",      label: "FULLY REUSABLE" },
];

const projects = [
  {
    img: "/Modblock/MODBLOCK ACTIVATION NIKE 2.png",
    title: "FESTIVAL BAR & HOSPITALITY SUITE",
    category: "Hospitality",
    desc: "A fully serviced Modblock bar and VIP hospitality suite deployed across a three-day outdoor festival — including a licensed bar, prep kitchen, covered terrace and private dining area, installed in under 18 hours.",
  },
  {
    img: "/Modwall/Modwall 1.jpg",
    title: "POP-UP RESTAURANT — CITY CENTRE",
    category: "Food & Beverage",
    desc: "A temporary 80-cover restaurant built using Modblock structure and Modwall interiors in an urban courtyard — open for a 6-week residency with full kitchen, bar and dining room finish to restaurant standard.",
  },
];
  ...
  return (
    <>
      ...
      <section style={{
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/Modblock/Gaucho - Modblock.png"
          alt=""
          onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
          style={{
            position: "absolute",
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            PERMANENT QUALITY.<br />TEMPORARY<br />TIMELINE.
          </h1>
          <p style={{
            ...
            Pop-up restaurants, festival bars and branded hospitality suites built to hotel standard.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              GUESTS EXPECT FIVE STAR.<br />
              <span style={{ color: "#C6FF02" }}>YOU HAVE 24 HOURS<br />TO DELIVER IT.</span>
            </h2>
            <p style={{
              fontSize: "15px",
              ...
              Hospitality and food & beverage environments live and die by the guest experience — but temporary venues face an impossible constraint: hotel-standard finish in a fraction of the time, on a fraction of the budget. Modsol closes that gap without closing on quality.
            </p>
          </div>
          ...
          <div style={{
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/Modblock/COFFEE SHOP 2.png"
              alt="Hospitality environment"
              onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
              style={{
                width: "100%",
                height: "100%",
      ...
      <section style={{
        ...
        <p style={{
          ...
          Tell us about your next hospitality or restaurant brief.
        </p>
        <Link
          href="/contact"
          style={{
