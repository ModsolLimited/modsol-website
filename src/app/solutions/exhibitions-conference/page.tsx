...
const tabContent: Record<Tab, {
  ...
  "THE MODBLOCK": {
    ...
    logoWidth: 160,
    heading: "THE STAND THAT COMMANDS THE ROOM",
    body: "The Modblock provides the primary structural framework for exhibition stands, conference pavilions and trade show environments — from single-storey feature stands to double-deck brand suites. Flat-packed, rapidly assembled and engineered to meet strict venue regulations without sacrificing design ambition.",
    bullets: [
      "Double-deck configurations available",
      "Compliant with major venue structural requirements",
      "Redeployable across multiple shows and locations",
    ],
  ...
  "THE MODWALL": {
    ...
    logoWidth: 160,
    heading: "DEFINE THE SPACE. OWN THE FLOOR.",
    body: "The Modwall creates the clean, professional interiors that exhibition and conference environments demand — defining meeting rooms, product display zones and private briefing suites within any stand footprint. Interchangeable surface finishes allow full brand expression without permanent build.",
    bullets: [
      "Integrated door and window panel options",
      "Full graphic wrap and surface finish range",
      "Tool-free reconfiguration between shows",
    ],
  ...
  "THE MODFRAME": {
    ...
    logoWidth: 160,
    heading: "OVERHEAD PRESENCE. ZERO COMPROMISE.",
    body: "The Modframe delivers the large-format overhead and fascia graphic environments that give exhibition stands their visual presence from across the hall. Scalable to any ceiling height or span, it integrates with Modblock structures or stands alone as a branded canopy or entrance feature.",
    bullets: [
      "Large-format graphic integration at height",
      "Manufactured to any span — no fixed limit",
      "Rapid installation — no specialist tools required",
    ],
...
const stats = [
  { value: "3 DAYS", label: "TYPICAL BUILD" },
  { value: "ANY",    label: "CLEAR SPAN" },
  { value: "CE",     label: "CERTIFIED" },
  { value: "100%",   label: "REDEPLOYABLE" },
];

const projects = [
  {
    img: "/Modblock/MODBLOCK ACTIVATION NIKE 2.png",
    title: "DOUBLE-DECK BRAND PAVILION",
    category: "Trade Exhibition",
    desc: "A 400m² double-deck Modblock pavilion delivered for a major technology brand at a tier-1 European trade show — including private meeting suites, product display zones and a rooftop hospitality terrace, built in 4 days.",
  },
  {
    img: "/Modwall/Modwall 1.jpg",
    title: "CONFERENCE BREAKOUT ENVIRONMENT",
    category: "Conference & Summit",
    desc: "Modwall used to partition a 1,200m² conference floor into 12 branded breakout rooms and sponsor activation zones — fully installed overnight, reconfigured between sessions, and stripped in under 8 hours.",
  },
];
  ...
  return (
    <>
      ...
      <section style={{
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/Modblock/Modblock - Exhibition.png"
          alt=""
          onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }}
          style={{
            position: "absolute",
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            WHERE BRANDS<br />BECOME<br />ARCHITECTURE.
          </h1>
          <p style={{
            ...
            Exhibition halls, trade shows and conference environments demand presence at scale.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              EVERY BRAND WANTS<br />
              <span style={{ color: "#C6FF02" }}>TO OWN THE ROOM.<br />FEW HAVE THE STRUCTURE.</span>
            </h2>
            <p style={{
              fontSize: "15px",
              ...
              Exhibition and conference environments are unforgiving — tight build windows, strict venue compliance requirements and the pressure to outshine every competitor on the floor. Traditional build methods are too slow, too expensive and too wasteful for the modern exhibition calendar.
            </p>
          </div>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Tell us about your next exhibition or conference brief.
        </p>
        <Link
          href="/contact"
          style={{
