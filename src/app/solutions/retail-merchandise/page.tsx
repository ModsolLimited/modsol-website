...
const tabContent: Record<Tab, {
  ...
  "THE MODWALL": {
    ...
    logoWidth: 160,
    heading: "THE DISPLAY WALL. REIMAGINED.",
    body: "The Modwall transforms interior retail space into a fully configured merchandise display environment — slat wall panels, peg board options, integrated shelving and branded surface finishes all within a system that installs in hours. Every panel is interchangeable, so layouts adapt to any product range or season.",
    bullets: [
      "Slat wall and peg board panel options",
      "Integrated shelving and display fixture mounts",
      "Interchangeable surfaces for seasonal refresh",
    ],
  ...
  "THE MODFRAME": {
    ...
    logoWidth: 160,
    heading: "BRAND IT. ROOF IT. OWN IT.",
    body: "The Modframe delivers the branded exterior fascia and roofing that make retail environments unmissable — large-format graphic panels, canopy structures and overhead signage systems that drive footfall and reinforce brand identity from a distance. Rapid installation and fully redeployable.",
    bullets: [
      "Large-format fascia and graphic panel integration",
      "Canopy and covered outdoor retail configurations",
      "Redeployable across multiple retail activations",
    ],
...
const stats = [
  { value: "2 HRS",  label: "FROM INSTALL" },
  { value: "SLAT",   label: "WALL & PEG BOARD" },
  { value: "FLAT",   label: "PACK LOGISTICS" },
  { value: "ANY",    label: "SURFACE FINISH" },
];

const projects = [
  {
    img: "/Modblock/MODBLOCK ACTIVATION NIKE 2.png",
    title: "FLAGSHIP POP-UP RETAIL STORE",
    category: "Retail Activation",
    desc: "A 120m² temporary flagship retail store built using the Modblock system for a major sportswear brand — installed in 6 hours, open for 8 weeks, stripped and redeployed to the next city within 48 hours of closing.",
  },
  {
    img: "/Modframe/Renault.jpg",
    title: "FESTIVAL MERCHANDISE ENVIRONMENT",
    category: "Merchandise & Retail",
    desc: "A full merchandise retail environment deployed across a major UK music festival — Modblock structures, Modwall display interiors and Modframe branded fascias delivering a complete retail campus on a 24-hour build window.",
  },
];
    ...
    <>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Temporary retail environments engineered to convert — from festival merch to flagship brand activations.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{
              ...
              <span style={{ color: "#C6FF02" }}>YOUR STORE NEEDS<br />TO MOVE WITH IT.</span>
            </h2>
            <p style={{
              fontSize: "15px",
              ...
              Temporary retail environments are expected to deliver the full brand experience of a permanent flagship — but on a fraction of the timeline, budget and logistical footprint. The challenge is building a store that converts without the permanence that makes it impossible to deploy at pace.
            </p>
          </div>
      ...
      <section style={{ background: "#0A0A0A", paddingTop: "clamp(80px, 10vh, 120px)" }}>
        ...
        {tabs.map((tab) => {
          ...
          const tabImg = tab === "THE MODBLOCK"
            ? "/Modblock/MODBLOCK ACTIVATION NIKE 2.png"
            : tab === "THE MODWALL"
      ...
      <section style={{
        ...
        <p style={{
          ...
          Tell us about your next retail or merchandise brief.
        </p>
        <Link
          href="/contact"
          style={{
