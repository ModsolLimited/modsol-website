        ...
        <div className="footer-top">
          <div className="footer-brand">
            <Link href="/" style={{ display: "inline-block", marginBottom: "12px" }}>
              <Image src="/Modsol/modsol YELLOW NB.png" alt="Modsol" height={40} width={120} style={{ height: "40px", width: "auto" }} />
            </Link>
            <p>Modular solutions engineered for the next generation of modular architecture. Events. Exhibitions. Hospitality. Retail.</p>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link href="/products/modlab">The Modlab</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link href="/projects/case-studies">The Projects</Link></li>
