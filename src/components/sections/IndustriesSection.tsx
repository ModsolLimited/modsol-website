              ...
              <div className="industry-item">
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontFamily: "var(--font-display)", fontSize: "clamp(28px, 3vw, 42px)", color: "var(--yellow)", lineHeight: 1 }}>{ind.stat}</div>
                    <div style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "var(--muted)", letterSpacing: "0.18em", textTransform: "uppercase", marginTop: "2px" }}>{ind.statLabel}</div>
                  </div>
                </div>
