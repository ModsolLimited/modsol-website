...
export default function NewsletterSignup() {
  return (
    <div style={{ background: "rgba(198,255,2,0.04)", border: "1px solid rgba(198,255,2,0.15)", padding: "32px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <p style={{ fontSize: "13px", color: "var(--muted)", lineHeight: "1.6", marginBottom: "24px" }}>Monthly insights on modular architecture, event design, and the Modsol platform. No noise.</p>
